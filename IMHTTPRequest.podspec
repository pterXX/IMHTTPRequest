...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is IMHTTPRequest
                   DESC

  s.homepage     = "https://github.com/pterXX/IMHTTPRequest"
  ...
  s.source       = { :git => "https://github.com/pterXX/IMHTTPRequest.git", :tag => s.version.to_s }
  ...
  s.source_files  = "IMHTTPRequest/IMHTTPRequest/**/*.{h,m,swift}"
  ...
  s.frameworks = "UIKit", "Foundation","WebP"
